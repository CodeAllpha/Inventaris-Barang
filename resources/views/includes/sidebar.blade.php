<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="{{ route('petugas.dashboard') }}" target="_blank">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item "> 
          <a class="nav-link {{ Request::url() == url('/') ? 'active' : '' }} " href="{{ route('petugas.dashboard') }}">
        ...
        <li class="nav-item">
          <a class="nav-link {{ Request::url() == url('/jenis') ? 'active' : '' }} 
          {{ Request::url() == url('/jenis/create') ? 'active' : '' }} " href="{{ route('pages.jenis.index') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link {{ Request::url() == url('/peminjaman') ? 'active' : '' }} " href="{{ route('pages.peminjaman.index') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
